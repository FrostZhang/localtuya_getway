...
class LocaltuyaFan(LocalTuyaEntity, FanEntity):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(device, config_entry, fanid,cid, _LOGGER, **kwargs)
        self._is_on = False
        ...
        if percentage is not None:
            ...
            if self._use_ordered_list:
                await self._device.set_dp(
                    ...
                    self._config.get(CONF_FAN_SPEED_CONTROL), self._cid
                )
                _LOGGER.debug(
    ...
    async def async_oscillate(self, oscillating: bool) -> None:
        ...
        await self._device.set_dp(
            oscillating, self._config.get(CONF_FAN_OSCILLATING_CONTROL), self._cid
        )
        self.schedule_update_ha_state()
    ...
    async def async_set_direction(self, direction):
        ...
        await self._device.set_dp(value, self._config.get(CONF_FAN_DIRECTION), self._cid)
        self.schedule_update_ha_state()
