...
class LocaltuyaClimate(LocalTuyaEntity, ClimateEntity):
    ...
    async def async_set_temperature(self, **kwargs):
        ...
        if ATTR_TEMPERATURE in kwargs and self.has_config(CONF_TARGET_TEMPERATURE_DP):
            ...
            await self._device.set_dp(
                temperature, self._config[CONF_TARGET_TEMPERATURE_DP], self._cid
            )
    ...
    async def async_set_hvac_mode(self, hvac_mode):
        ...
        await self._device.set_dp(
            self._conf_hvac_mode_set[hvac_mode], self._conf_hvac_mode_dp, self._cid
        )
    ...
    async def async_set_preset_mode(self, preset_mode):
        ...
        if preset_mode == PRESET_ECO:
            await self._device.set_dp(self._conf_eco_value, self._conf_eco_dp, self._cid)
            return
        await self._device.set_dp(
            self._conf_preset_set[preset_mode], self._conf_preset_dp, self._cid
        )
